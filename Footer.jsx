...
function Footer() {
  return (
    <div className='w-full min-h-fit bg-zinc-900 flex overflow-hidden'>
        <div><h1 className='flex uppercase text-8xl pt-16 pl-12 font-semibold leading-none tracking-tighter'>eye-<br></br>opening</h1>
      <div className='w-1/2 flex items-end justify-start h-screen pb-56'>
      <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className=' pt-16 pl-20 ml-32 pr-14 tracking-tighter font-[Bebas Neue]'>
            <h1 className='text-8xl font-semibold leading-0'>PRESENTATIONS</h1>

        

 
 <div className='text-xl leading-none pt-10 '>
            <p>S:</p><br></br>
            <a href='#'>Instagram</a><br></br>
            <a href='#'>Behance</a><br></br>
            <a href='#'>Facebook</a><br></br>
            <a href='#'>Twitter</a><br></br>
            <div className='text-xl leading-none pt-10 '>
            <p className=' text-xl leading-none  '> L :<br></br><br></br>

202-1965 W 4th Ave<br></br>
Vancouver, Canada<br></br><br></br>

30 Chukarina St<br></br>
Lviv, Ukraine<br></br><br></br><br></br>
E :<br></br>
...
<div className='text-xl leading-none bottom-52 relative underline leading-0'>
<p>M :</p><br></br>
<a href='#'>Home</a><br></br>
<a href='#'>Services</a><br></br>
<a href='#'>Our Work</a><br></br>
...
<div className="Links flex gap-20 text-zinc-700 ">
      {["© ochi design 2024. Legal Terms","Website by Obys"].map((item,index)=>(<a key={index}
      className={`text-lg   ${index===1 &&"ml-20 pl-60"}`}>{item}</a>
      ))}
    </div>
</div>
